...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "Накладная") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "Накладная", "Накладная", 
			ПечатьДокумента(МассивОбъектов, ОбъектыПечати, ПараметрыПечати),,"Документ.bsk_РасходнаяНакладная.ПФ_MXL_Накладная");
	КонецЕсли;
...
Функция ПечатьДокумента(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	ТабличныйДокумент.КлючПараметровПечати	= "ПАРАМЕТРЫ_ПЕЧАТИ_bsk_РасходнаяНакладная_Накладная";
	...
	|	) КАК Материалы
	|ИЗ
	|	Документ.bsk_РасходнаяНакладная КАК Документ
	|ГДЕ
	...
	Пока Шапка.СледующийПоЗначениюПоля("Ссылка") Цикл
		...
		Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.bsk_РасходнаяНакладная.ПФ_MXL_Накладная");
		...
		ОбластьМакета.Параметры.Заголовок = 
			СтрШаблон("Расходная накладная %1 от %2", 

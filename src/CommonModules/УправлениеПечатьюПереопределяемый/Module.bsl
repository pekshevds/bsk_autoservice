...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	//+bsk
	СписокОбъектов.Добавить(Документы.bsk_ЗаказНаряд);
	СписокОбъектов.Добавить(Документы.bsk_ПеремещениеМатериалов);
	СписокОбъектов.Добавить(Документы.bsk_ПриходнаяНакладная);
	СписокОбъектов.Добавить(Документы.bsk_РасходнаяНакладная);
	//-bsk
